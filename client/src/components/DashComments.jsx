...
const DashComments = () => {
  ...
  const fetchComments = async () => {
    try {
      const res = await fetch(`${url}/api/comment/get-comments`, {
        method: "GET",
        credentials: "include",
      });
  ...
  const handleShowMore = async () => {
    ...
    try {
      const res = await fetch(
        `${url}/api/comment/get-comments?startIndex=${startIndex}`
      );
      const data = await res.json();
      if (res.ok) {
  ...
  const handleDeleteComment = async () => {
    setShowModal(false);
    try {
      const res = await fetch(`${url}/api/comment/delete/${commentIdToDelete}`, {
        method: "DELETE",
        credentials:'include'
      });
      const data = await res.json();
